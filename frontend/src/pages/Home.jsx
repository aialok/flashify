...
import { Plus, Search, Book, Brain, Pencil, User, ArrowRight } from "lucide-react";
    ...
    <div className="min-h-screen text-gray-800 bg-gray-100">
      <main className="max-w-7xl mx-auto px-4 py-12">
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-gray-900">Create Flashcards</h2>
            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Generate flashcards automatically</p>
                </div>
              </div>
        ...
        <section>
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold text-gray-900">Recent Flashcards</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {["JavaScript Basics", "World Capitals", "Biology Terms"].map(
              (deck, index) => (
                ...
                >
                  <h3 className="font-semibold text-xl mb-2">{deck}</h3>
